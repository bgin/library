...
c
      ...
      character*64 machin,mch(nmx)
      character*64 mchtyp(nmx),mx
      character*64 site
      character*16 user
      data curver/' mesa(1.2);5/30/91;unix.'/
      data copyr/'     (c) 1990, the university of california.'/
      data site /'National Institute of Standards and Technology;'/
c
c
 1000 format(a80)
 1020 format(a80,/)
 1010 format(5x,80a1)
     ...
     $              'M. Page, R. Lucchese, T. N. Rescigno' //
     $              'and B. I. Schneider.'
      mch(1) = 'feynman'
      mch(2) = 'fermi'
      mch(3) = 'dirac'
      mchtyp(1) = ' 16 core Sandy Bridge Dell 3.2 GHz '
      mchtyp(2) = ' 2.3GHz I7 Dual mac-pro laptop '
      mchtyp(3) = ' 20 core Ivy Bridge 3.2GHz plus Intel Phi '
