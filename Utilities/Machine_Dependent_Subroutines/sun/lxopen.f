...
c               names(34)        'hconfig' 
c
c      new files added by bis for rmatrix data manipulation and time-dependent work
c
c               names(35)        'rmtrx' 
c
c               names(36)        'tdse' 
...
c
      ...
      if (names(32).eq.'fedvr') names(32)=tmp(1:ltmp)//'/fedvr'
      ...
      if (names(36).eq.'tdse')    names(36)=tmp(1:ltmp)//'/tdse'
c
